...
module.exports.execute = async ({ interaction, lang }) => {
        ...
        try {
                ...
                BotLogger.logModeration(interaction.client, interaction.guildId, "untimeout", interaction.user, user, "Timeout removed").catch(err => console.error("Error logging moderation:", err));
        } catch (error) {
