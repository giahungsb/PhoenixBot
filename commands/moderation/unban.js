...
module.exports.execute = async ({ interaction, lang }) => {
        ...
        try {
                ...
                BotLogger.logModeration(interaction.client, interaction.guildId, "unban", interaction.user, banEntry.user, "Unbanned").catch(err => console.error("Error logging moderation:", err));
        } catch (error) {
