...
module.exports.execute = async ({ interaction, lang }) => {
        ...
        BotLogger.logModeration(interaction.client, interaction.guildId, "timeout", interaction.user, user, `${reason} (Duration: ${durationInput})`).catch(err => console.error("Error logging moderation:", err));
